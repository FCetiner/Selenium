...
public class C02_RelativeXpath {
    public static void main(String[] args) {
        ...
        WebElement boston=driver.findElement(By.id("pid11_thumb"));
        WebElement byArea=driver.findElement(By.id("pid8_thumb"));
        WebElement newYorkCity=driver.findElement(By.id("pid3_thumb"));


        //2 ) Berlin’i  3 farkli relative locator ile locate edin
        WebElement berlin1=driver.findElement(RelativeLocator.with(By.tagName("img")).toRightOf(boston).above(sailor).toLeftOf(byArea));
        WebElement berlin2=driver.findElement(RelativeLocator.with(By.tagName("img")).toRightOf(boston).toLeftOf(byArea));
        WebElement berlin3=driver.findElement(RelativeLocator.with(By.tagName("img")).below(newYorkCity).above(sailor));
